...
const TopTabs: FC<TopTabsProps> = ({
        ...
        <li key={index} className="mr-2">
          <div
            className={`inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 hover:cursor-pointer ${
              currentNavigate === index ? "border-gray-300 text-gray-600" : ""
            }`}
  ...
  return (
    <div className="text-sm font-medium text-center text-gray-500 dark:text-gray-400 dark:border-gray-700 pt-3">
